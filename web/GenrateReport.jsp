<!--select * from report where DATE between '2023-02-19 00:00:00' and '2023-03-19 06:00:00';-->
...
<html lang="en">
	...
	<body>
            <%
                String start = request.getParameter("ITEM_NO");
            %>
			...
			<div class="row content">
				...
				<div class="col-md-7 border-right">
					<div class="p-3 py-5">
						...
						>
							<h3 class="text-center">Generate Report</h3><br>
						</div>
