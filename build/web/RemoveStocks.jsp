...
<html lang="en">
            ...
            public class Data{
                ...
                public ResultSet getData(int ITEM_NO){
                    try{
                        ...
                        selectId = connection.prepareStatement("SELECT * FROM ITEMS WHERE ITEM_NO = '"+ITEM_NO+"' AND STATUS = 1;");
    ...
    <body>
        <%
            ...
            if(ITEM_NO != null){
                Data data = new Data();
                rs = data.getData(Integer.parseInt(ITEM_NO));
            }
        %>
            ...
            <div class="container-fluid">
                ...
                <div
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"
                            ><a href="RemoveStocks.jsp">Remove Stock</a></li
                        >
                        <li
                ...
                <div class="col-md-7 border-right">
                    <div class="p-3 py-5">
                        <div
                            ...
                            >
                            <h3 class="text-center">Give Stocks</h3><br />
                        </div>
                        <div class="row mt-2">
                            ...
                            <div class="col-md-12">
                                ...
                                %>
                                    <input
                                        type="submit"
                                        id="button"
                                        class="btn-special btn-primary btn-md text-center m-b-20"
                                        name="submit"
                                        value="Give"
                                        /></center>
